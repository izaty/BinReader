...
public:
	...
	// Appended on Mar.20,'16
	// start
	void EnableWriteFunc(BOOL bEnable) {m_bWriteFunc = bEnable;}
	BOOL IsWriteFuncEnabled() const {return m_bWriteFunc;}
	// end

	virtual BOOL IsClearRequired() const {return m_bClearRequired;}
